                                ...
                                <li class="active">
                                 ...
                                 <li class="active">
                                    <a href="existing_client.php">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Existing Client</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                    <li class="active">
                                    <a href="new_client.php">
                                        <span class="pcoded-micon"><i class="ti-pie-chart "></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">New Client</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                    <li class="active">
                                    <a href="jobseeker.php">
                                        <span class="pcoded-micon"><i class="ti-pie-chart "></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Jobseeker</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
